	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0009 > 0 {
			...
			for zb0016 > 0 {
				...
				if zb0019 && !AssetIndexLess(zb0018, zb0001) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0018 = zb0001
		...
		if zb0009 > 0 {
			...
			for zb0020 > 0 {
				...
				if zb0023 && !AssetIndexLess(zb0022, zb0003) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0022 = zb0003
		...
		if zb0009 > 0 {
			...
			for zb0028 > 0 {
				...
				if zb0031 && !AppIndexLess(zb0030, zb0005) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0030 = zb0005
		...
		if zb0009 > 0 {
			...
			for zb0032 > 0 {
				...
				if zb0035 && !AppIndexLess(zb0034, zb0007) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0034 = zb0007
		...
		for zb0009 > 0 {
			...
			case "apar":
				...
				for zb0043 > 0 {
					...
					if zb0046 && !AssetIndexLess(zb0045, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0045 = zb0001
			...
			case "asset":
				...
				for zb0047 > 0 {
					...
					if zb0050 && !AssetIndexLess(zb0049, zb0003) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0049 = zb0003
			...
			case "appl":
				...
				for zb0055 > 0 {
					...
					if zb0058 && !AppIndexLess(zb0057, zb0005) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0057 = zb0005
			...
			case "appp":
				...
				for zb0059 > 0 {
					...
					if zb0062 && !AppIndexLess(zb0061, zb0007) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0061 = zb0007
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0003 > 0 {
			...
			for zb0011 > 0 {
				...
				if zb0014 && !StringLess(zb0013, zb0001) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0013 = zb0001
		...
		for zb0003 > 0 {
			...
			case "tkv":
				...
				for zb0019 > 0 {
					...
					if zb0022 && !StringLess(zb0021, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0021 = zb0001
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0003 > 0 {
			...
			for zb0009 > 0 {
				...
				if zb0012 && !StringLess(zb0011, zb0001) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0011 = zb0001
		...
		for zb0003 > 0 {
			...
			case "gs":
				...
				for zb0023 > 0 {
					...
					if zb0026 && !StringLess(zb0025, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0025 = zb0001
