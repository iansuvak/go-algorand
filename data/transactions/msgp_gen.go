	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0006 > 0 {
			...
			for zb0010 > 0 {
				...
				if zb0013 && !Uint64Less(zb0012, zb0001) {
					err = &msgp.ErrNonCanonical{}
					return
				}
				zb0012 = zb0001
		...
		for zb0006 > 0 {
			...
			case "ld":
				...
				for zb0020 > 0 {
					...
					if zb0023 && !Uint64Less(zb0022, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0022 = zb0001
