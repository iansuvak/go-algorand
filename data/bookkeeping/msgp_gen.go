		...
		for zb0004 > 0 {
			...
			case "spt":
				...
				for zb0016 > 0 {
					...
					if zb0019 && !protocol.StateProofTypeLess(zb0018, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0018 = zb0001
