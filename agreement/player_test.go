...
func TestPlayerPropagatesProposalPayload(t *testing.T) {
	...
	m := message{
		MessageHandle:           &messageStringMetadata{raw: "msghandle"},
		UnauthenticatedProposal: payload.u(),
	}
	inMsg = messageEvent{
		T:     payloadPresent,
...
func TestPlayerDisconnectsFromMalformedVotes(t *testing.T) {
	...
	m := message{
		Vote:                vv,
		UnauthenticatedVote: vv.u(),
		MessageHandle:       &messageStringMetadata{raw: "uniquemalformedvote"},
	}
	inMsg := messageEvent{
		T:     voteVerified,
		Input: m,
...
func TestPlayerDisconnectsFromMalformedBundles(t *testing.T) {
	...
	m := message{
		...
		MessageHandle:         &messageStringMetadata{raw: "uniquemalformedBundle"},
	}
	inMsg := messageEvent{
		Err:   verifyError,
		T:     bundleVerified,
...
func TestPlayerRequestsPipelinedPayloadVerification(t *testing.T) {
	...
	m := message{
		...
		MessageHandle:           &messageStringMetadata{raw: "r2"},
	}
	inMsg = messageEvent{
		T:     payloadPresent,
		Input: m,
