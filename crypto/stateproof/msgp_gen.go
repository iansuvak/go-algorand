		...
		for zb0004 > 0 {
			...
			case "r":
				...
				for zb0014 > 0 {
					...
					if zb0017 && !Uint64Less(zb0016, zb0001) {
						err = &msgp.ErrNonCanonical{}
						return
					}
					zb0016 = zb0001
